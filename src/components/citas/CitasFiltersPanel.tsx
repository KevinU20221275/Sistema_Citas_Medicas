        ...
        <article className={className}>       
                <div className="grid grid-cols-2 items-center justify-around w-full px-4 gap-4">
                    <fieldset className="col-span-2 flex gap-2 items-center justify-center">
                        ...
                        <button 
                        className={`${citas === CITAS_FILTERS.PROXIMAS ? 'bg-indigo-500 filter-btn-active hover:bg-indigo-600 text-white' : 'bg-zinc-200 filter-btn-inactive hover:bg-indigo-200 '} px-3 py-1 rounded-full cursor-pointer  transition-all`}
                        onClick={() => setFilters(prev => ({
                            ...prev,
                    ...
                    <fieldset className="col-span-2">
                        ...
                        <div className="flex justify-center items-center gap-2">
                            <button 
                            className={`${estado === CITA_ESTADO_FILTERS.TODOS ? 'bg-indigo-500 filter-btn-active hover:bg-indigo-600 text-white' : 'bg-zinc-200 filter-btn-inactive hover:bg-indigo-200'} px-3 py-1 rounded-full cursor-pointer  transition-all`}
                            onClick={() => setFilters(prev => ({
                                ...prev,
                            ...
                            <button 
                            className={`${estado === CITA_ESTADO_FILTERS.PENDIENTE ? 'bg-indigo-500 filter-btn-active hover:bg-indigo-600 text-white' : 'bg-zinc-200 filter-btn-inactive hover:bg-indigo-200'} px-3 py-1 rounded-full cursor-pointer  transition-all`}
                            onClick={() => setFilters(prev => ({
                                ...prev,
                            ...
                            <button 
                            className={`${estado === CITA_ESTADO_FILTERS.COMPLETADA ? 'bg-indigo-500 filter-btn-active hover:bg-indigo-600 text-white' : 'bg-zinc-200 filter-btn-inactive hover:bg-indigo-200'} px-3 py-1 rounded-full cursor-pointer  transition-all`}
                            onClick={() => setFilters(prev => ({
                                ...prev,
                            ...
                            <button 
                            className={`${estado === CITA_ESTADO_FILTERS.CANCELADA ? 'bg-indigo-500 filter-btn-active hover:bg-indigo-600 text-white' : 'bg-zinc-200 filter-btn-inactive hover:bg-indigo-200'} px-3 py-1 rounded-full cursor-pointer  transition-all`}
                            onClick={() => setFilters(prev => ({
                                ...prev,
